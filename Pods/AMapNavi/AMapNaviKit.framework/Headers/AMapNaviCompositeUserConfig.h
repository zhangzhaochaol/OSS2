...
/**
 * @brief 设置导航组件设置页面是否展示语音辅助功能 注意：设置页面的语音辅助功能的展示，只有在用户在这里打开了语音辅助开关和组件没有实现外置语音的代理，且manager使用了内置语音的时候才生效  since 8.0.1
 * @param need 是否显示，默认为NO.
 */
- (void)setShowVoiceAssistEnable:(BOOL)showVoiceAssistEnable;
