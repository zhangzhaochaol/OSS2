#
#  Be sure to run `pod spec lint OSS2.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "zzc"
  # spec.authors            = { "zzc" => "zhangzc" }
  # spec.social_media_url   = "https://twitter.com/zzc"
