...
+ (Yuan_PolyLine *)polylineForCoordinateString:(NSString *)coordinateString
{
    ...
    Yuan_PolyLine *polyline = [Yuan_PolyLine polylineWithCoordinates:coordinates count:count];
