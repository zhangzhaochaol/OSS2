//
//  Inc_WKWebViewJavascriptBridge.m
//
...
@implementation Inc_WKWebViewJavascriptBridge {
    __weak WKWebView* _webView;
    __weak id<WKNavigationDelegate> _webViewDelegate;
    long _uniqueId;
    Inc_WebViewJavascriptBridgeBase *_base;
}

/* API
 *****/

+ (void)enableLogging { [Inc_WebViewJavascriptBridgeBase enableLogging]; }

+ (instancetype)bridgeForWebView:(WKWebView*)webView {
    Inc_WKWebViewJavascriptBridge* bridge = [[self alloc] init];
...
- (void)send:(id)data responseCallback:(Inc_WVJBResponseCallback)responseCallback {
...
- (void) _setupInstance:(WKWebView*)webView {
    ...
    _base = [[Inc_WebViewJavascriptBridgeBase alloc] init];
    _base.delegate = self;
}
